export default {
  ...
  'pages.article.title.required':'标题不允许为空',
  'pages.article.title.placeholder': '请输入标题',

  'pages.article.inro': '内容概述',
  'pages.article.inro.required':'内容概述不允许为空',
  'pages.article.inro.placeholder': '请输入内容概述',
